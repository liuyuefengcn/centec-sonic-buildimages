...
class Sfp(SfpBase):
    ...
    PLATFORM = "x86_64-ieu_ctc8180-r0"
    HWSKU  = "ieu-ctc8180"
    ...
    def __init__(self, sfp_index, sfp_type):
        ...
        self._port_cfgs = self._port_cfgs[0:-4] # ignore port for gearbox
        f.close()
        ...
        self.port_to_i2c_mapping = {
             ...
             76 : (13, 0x36, 0x11, 0, 0x36, 0x0e, 0),
             77 : (12, 0x36, 0x11, 1, 0x36, 0x0e, 1),
             78 : (11, 0x36, 0x11, 2, 0x36, 0x0e, 2),
             79 : (10, 0x36, 0x11, 3, 0x36, 0x0e, 3),
            ...
            238 : (57, 0x37, 0x13, 4, 0x37, 0x10, 4),
            239 : (56, 0x37, 0x13, 5, 0x37, 0x10, 5),
            236 : (55, 0x37, 0x13, 6, 0x37, 0x10, 6),
            237 : (54, 0x37, 0x13, 7, 0x37, 0x10, 7),
