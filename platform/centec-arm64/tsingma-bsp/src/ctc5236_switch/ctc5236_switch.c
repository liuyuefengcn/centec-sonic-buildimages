...
_sys_tsingma_peri_get_temp_with_code(u8 lchip, u32 temp_code, u32 * p_temp_val)
{
	u16 temp_mapping_tbl[SYS_TSINGMA_TEMP_TABLE_NUM + 1] = {
		804, 801, 798, 795, 792, 790, 787, 784, 781, 778, 775, 772, 769,
		    766, 763, 761, 758, 755, 752, 749,
													    /*-40~-21*/
		746, 743, 740, 737, 734, 731, 728, 725, 722, 719, 717, 714, 711,
...
EXPORT_SYMBOL(get_switch_temperature);
